  ...
  <transition name="popup-fade">
    <div class="modal-popup" @click.self="close">
      <div class="modal-popup__container">
        ...
        <div class="modal-popup__title">Мы отправим вам книгу на e-mail</div>
        
        <div class="modal-popup__content">
          <div class="content-form">
            <input class="content-form__input" type="email" placeholder="E-mail"/>
          </div>
          <div class="content-btn" @click="adopted">Получить книгу</div>
          ...
          <div class="content-subscription">
            <Checkbox 
              :is_active="false"
              class="content-subscription__checkbox"/>
            <div class="content-subscription__text">Скачивая книгу, Вы соглашаетесь получать интересные материалы о раннем развитии от Бэби-клуба</div>
          </div>
