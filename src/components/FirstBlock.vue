...
<template>
  <div class="first-block">
    ...
    <img class="hearts" src="@/assets/img/hearts.svg" alt="">
    <img class="hearts-mobile" src="@/assets/img/hearts-mobile.svg" alt="">
    
    <div class="container">
      <div class="first-block-content">
        <img class="child" src="@/assets/img/child.svg" alt="">
        <img class="child-mobile" src="@/assets/img/child-mobile.svg" alt="">
        ...
        <form @submit.prevent="fetchFn" class="first-block-content__form">
          ...
          <div class="form-fill">
            <input class="form-fill__input" type="text" placeholder="+7 (___)___-__-__" ref="phone" id="test-field"/>
